...
//dpi.configModbusTcpRules(new protectDeviceForm("172.16.10.137", "00:0b:ab:c6:60:12"), new modbusForm("any", "any", 12292, 12292, 6, 10, 700), true, false);
//dpi.configOPCRules(new protectDeviceForm("172.16.10.137", "MAC"), new OPCForm("any", "any"), true, false);
//dpi.configDNP3Rules(new protectDeviceForm("172.16.10.76", "MAC"), new DNP3Form("any", "any"), true, false);

var APC = require('./classes/configAPCRules.js');
//APC.configAPCRules("172.16.10.137", "ftp", true);
var CNC = require('./classes/configCNCRules.js');
//CNC.configCNCRules("172.16.10.167", "50", "172.16.10.1", "172.16.10.10", 12, 21, false);
...
//     "Macs": "00-A0-60"
// };
// //mongo.selectData(data, matchData, 'macs');
// mongo.insertData(matchData, "haha");